...
Clang 16.0.6 - This version of Clang suports C++ 17 fully, C++ 20 and C++ 23 partially - see https://clang.llvm.org/cxx_status.html#:~:text=Clang%20has%20support%20for%20some,std%3Dc%2B%2B2c%20option.
...
Example commands for latest CMake release at the time of this writing (3.26.4)
...
https://conan.io/center/recipes/boost?version=1.83.0
...
Example file contents for C++ 17 using CMake 3.26.4 and Boost 1.82:
...
Example output:
    ...
    /home/james/.conan2/p/boostb0117c3bfd046/s/src/boost/filesystem.hpp                      <-- Use the "/home/<username>/.conan2/p/boostb0117c3bfd046/s/src" part of this path.
